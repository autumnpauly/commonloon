...
```{r}
# Perform ANOVA
anova_model1 <- aov(n ~ tide, data = loon_2023_behavior)
...
contrasts <- matrix(c(0, 1, -1, 0, 0, 1), nrow = 3, byrow = TRUE,
                    dimnames = list(c("HIGH vs. MID", "HIHG vs. LOW", "MID vs. LOW"), NULL))

# Perform pairwise comparisons
pairwise_comparison <- glht(poisson_model, linfct = contrasts)
