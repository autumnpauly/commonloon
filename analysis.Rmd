...
REPORT: A Chi-squared test indicated a significant relationship between *G. immer* behavior and tidal condition (X^2(8, n=131) = 21.28, df = 8, p-value > 0.05). This indicates that there is a relationship between tidal height and *G. immer* behavior, allowing the null hypothesis to be rejected. 
...
divetimeggline <- ggline(loons_2024_loon, x = "location", y = "dive_time_obs",
       add = c(add = "mean_se", "jitter"),
       ylab = "Location", xlab = "Dive Time (seconds)", title = "G. Immer Dive Times at Various Sites")
...
## Tidal Influence on *G. immer* Behavior




## Coastal Exposure Level and Other Factors
