...
divetimeggline <- ggline(loons_2024_loon, x = "location", y = "dive_time_obs",
       add = c(add = "mean_se", "jitter"),
       ylab = "Location", xlab = "Dive Time (seconds)", title = "", label)
...
text(80, 20, bquote(r^2 == .(round((summary(lm3)$r.squared), 2))),cex=1)
text(80, 12, bquote(P == .(round((summary(lm3)$coefficients[2,4]), 2))),cex=1)
```
