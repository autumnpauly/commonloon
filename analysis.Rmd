...
REPORT: A Chi-squared test indicated that there was a relationship between the behavior of *G. immer* and tidal condition (Pearson's Chi-squared test; X-squared = 33.184, df = 10, p-value > 0.005). 

## Tidal Conditions and Dive Times in 2024

The next analysis that will be conducted will investigate the potential relationship between general tidal stages and *G. immer* dive times. 
...
The next analysis that will be conducted will be investigating the potential relationship between exposure level and *G. immer* abundance during the 2023 observation period. The null hypothesis for this analysis suggests that *G. immer* abundance will be independent of exposure level, whilst the hypothesis suggests the opposite. 
...
The next analysis that will be conducted will be investigating the potential relationship between exposure level and *G. immer* behavior during the 2023 observation period. 
...
REPORT: A Chi-squared test demonstrated that there was no significant association between exposure level and behavior (X^2(16,n=131) = 16.77, p = 0.40). 

## Wave Class and Behavior
The next analysis that will be conducted will be investigating the potential relationship between wave class and *G. immer* behavior during the 2023 observation period. 
...
The next analysis that will be conducted will be investigating the potential relationship between distance from shore and *G. immer* dive times during the 2024 observation period. 
...
The next analysis that will be conducted will be investigating the potential relationship between tidal height and *G. immer* dive times during the 2024 observation period. 
...
The next analysis that will be conducted will be investigating the potential relationship between specific tidal stage and *G. immer* dive times during the 2024 observation period. 
